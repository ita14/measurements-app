...
class ValidationProblemDetails(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errors"], typing_extensions.Literal["type"], typing_extensions.Literal["title"], typing_extensions.Literal["status"], typing_extensions.Literal["detail"], typing_extensions.Literal["instance"], typing_extensions.Literal["extensions"], ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errors"], typing_extensions.Literal["type"], typing_extensions.Literal["title"], typing_extensions.Literal["status"], typing_extensions.Literal["detail"], typing_extensions.Literal["instance"], typing_extensions.Literal["extensions"], ]):
        return super().get_item_oapg(name)
