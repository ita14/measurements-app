...
request_body_measurement = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _post_measurements_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_measurement.serialize(body, content_type)
...
class PostMeasurements(BaseApi):
    ...
    def post_measurements(
        ...
        return self._post_measurements_oapg(
            body=body,
